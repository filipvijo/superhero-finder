...
const AuthModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center bg-black/70">
      <motion.div
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        className="relative bg-white rounded-xl border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8 max-w-md w-full mx-4"
      >
